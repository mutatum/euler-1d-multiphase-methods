...
int main(int argc, char *argv[])
{
    ...
    using DGScheme = DGSEM<Physics, NumericalFlux, order, BoundaryConditions::LeftPeriodicBC, BoundaryConditions::RightPeriodicBC>;
    ...
    for (std::size_t i = 0; i < 10; ++i)
    {
        ...
        write_solution_to_file(U_convergence, domain_start, dx_conv, "solution_final" + std::to_string(i) + "_order" + std::to_string(DGScheme::PolynomialOrder) + ".csv",
